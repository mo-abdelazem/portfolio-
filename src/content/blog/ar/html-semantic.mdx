...
ومع بنية ذات معنى وتنسيق في مكانه، تأتي الطبقة التالية: السلوك — وهنا يدخل [JavaScript](/blog/javascript-fundamentals)، محوّلًا صفحة مبنية جيّدًا إلى شيء تفاعلي.
